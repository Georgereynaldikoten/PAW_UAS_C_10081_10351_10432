                ...
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                            <li><a class="dropdown-item" href="{{ route('orderans.index') }}">My Order</a></li>
                            <li><a class="dropdown-item active" href="{{ route('orderans.create') }}">New Order</a></li>
                        </ul>
                    </li>
                    <li class="nav-item dropdown">
...
<div class="bg bg-light text-dark">
    <div class="container min-vh-100 mt-1 d-flex align-items-center justify-content-center">
        ...
        <form action="{{ route('orderans.store') }}" method="POST">
            @csrf
            <div class="mb-3">
